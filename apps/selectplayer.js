...
export class SelectPlayer extends FormApplication {
    ...
    canShowPic() {
        ...
        return ((["person", "place", "poi", "event",mission", "oldentry", "organization", "shop", "oldentry", "journalentry", "base"].includes(type) || this.object.documentName == 'Actor') && this.object.img);
    }
